library(tidyverse)
iv <- seq(1,10,10/50)
y_1 <- 1+1.3*iv + rnorm(length(iv), sd = 0.5)
y_2 <- 3+0.7*(iv-5) + rnorm(length(iv), sd = 0.5)
...
text(0.92*my_points_y1$x[45],(my_points_y1$y[45]+my_points_y1$y[55])/2,"{", cex = 4)
...
text(-0.75,2.5,expression(beta["0(P1)"]), adj = 0.5, cex = 1.5)
arrows(-0.75,2.05,-0.05,coef(m_1)[[1]], lwd = 3, length = 0.15)
