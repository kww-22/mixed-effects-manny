library(tidyverse)
iv <- seq(1,10,10/50)
y_1 <- 3+0.7*iv + rnorm(length(iv), sd = 0.5)
y_2 <- 0.7*iv + rnorm(length(iv), sd = 0.5)
...
text(0.95*my_points_y1$x[45],(my_points_y1$y[45]+my_points_y1$y[55])/2,"{", cex = 2)
text(0.8*my_points_y1$x[45],(my_points_y1$y[45]+my_points_y1$y[55])/2, expression(beta["1(P1)"]), cex = 1.5)
text(0.97*my_points_y2$x[75],(my_points_y2$y[75]+my_points_y2$y[85])/2,"{", cex = 2)
text(0.89*my_points_y2$x[75],(my_points_y2$y[75]+my_points_y2$y[85])/2, expression(beta["1(P2)"]), cex = 1.5)
text(1,-1.5,expression(beta["0(P2)"]), adj = 0, cex = 1.5)
arrows(0.95,-1.5,0.05,coef(m_2)[[1]], lwd = 3, length = 0.15)
text(-0.75,1.5,expression(beta["0(P1)"]), adj = 0.5, cex = 1.5)
arrows(-0.75,1.9,-0.05,coef(m_1)[[1]], lwd = 3, length = 0.15)
